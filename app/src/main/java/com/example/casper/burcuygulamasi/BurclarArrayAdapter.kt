...
class BurclarArrayAdapter(var gelenContext: Context, resource: Int, textViewResourceId: Int, var burcAdi: Array<String>, var burcTarih: Array<String>,var  burcResim: Array<Int>)
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View? {
        ...
        if(tek_satir_view == null){
            ...
            tek_satir_view=inflater.inflate(R.layout.tek_satir_layout, parent, false)
        ...
        viewHolder.burcResim.setImageResource(burcResim[position])
        viewHolder.burcAdi.setText(burcAdi[position])
...
//        Log.e("TEST", ""+tek_satir_view.layoutParams)
    ...
    class ViewHolder(tek_satir_view:View?){
        ...
        init {
            this.burcResim=tek_satir_view!!.imgBurcFoto
